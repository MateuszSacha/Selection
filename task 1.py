#mateusz sacha
#30/09/2014
#selection class exercises. task 1
...
if month == 1:
    ...
    print("You have entered a number which is less than 1. Please enter a number between 1 ans 12")
elif month > 12:
    print("You have entered anumber which is greater than 12. Please enter a number between 1 and 12")
